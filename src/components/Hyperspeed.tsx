...
const sideSticksVertex = `
  ...
  void main(){
    ...
    float time = mod(uTime * 30. + aOffset, uTravelLength);
...
class App {
  ...
  init() {
    ...
    this.leftCarLights.mesh.position.setY(0);

    this.rightCarLights.init();
    this.rightCarLights.mesh.position.setX(options.roadWidth / 2 + options.islandWidth / 2);
    this.rightCarLights.mesh.position.setY(0);

    this.leftSticks.init();
    this.leftSticks.mesh.position.setX(-(options.roadWidth + options.islandWidth / 2));
    this.leftSticks.mesh.position.setY(0);
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
  ...
  useEffect(() => {
    ...
    console.log('Initializing Hyperspeed animation...');
    ...
    try {
      ...
      console.error('Error initializing Hyperspeed:', error);
    }
